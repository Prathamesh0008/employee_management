        ...
        >
          ...
          <div className="mb-3 rounded-lg border border-[#1a2742] bg-[#071426]/80 px-3 py-2">
            ...
            <div className="mb-3 grid grid-cols-2 gap-2">
              ...
              className="flex items-center justify-center gap-1.5 rounded-lg border border-[#0f766e]/40 bg-[#062a2d] px-2 py-2 text-xs font-semibold text-[#5eead4] transition hover:bg-[#0b3b3f] disabled:opacity-40"
            >
                  ...
                  <div className="mb-2 h-1.5 overflow-hidden rounded-full bg-[#0b1b33]">
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
                        ...
                        className="rounded-md border border-[#0f766e]/40 bg-[#052e2b] px-2 py-1.5 text-[11px] font-semibold text-[#5eead4] transition hover:bg-[#0b3b3f] disabled:opacity-40"
                      >
